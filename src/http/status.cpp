...
#include "httpony/http/status.hpp"
#include <map>
...
static const char* status_message(unsigned code)
{
...
Status::Status(unsigned code)
    : code(code), message(status_message(code))
{
}

Status::Status(unsigned code, std::string message)
